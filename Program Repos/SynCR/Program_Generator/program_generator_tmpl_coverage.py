...
class ProgramGeneratorFull_Coverage(ProgramGenerator):
    def __init__(self, num_programs: int = 1, language: str = "C++", template_type: str = "random"):
        ...
        config.update_config_value("PROGRAM_GENERATION", "format_generated_code", True)
        config.update_config_value("PROGRAM_GENERATION", "static_analysis_of_generate_code", True)
