...
class TemplateManagerConstants:
    ...
    EXCLUDE_LIST: Final[str] =['FUNCTION_DEFINITION_NON_PARAM','FUNCTION_DEFINITION','FUNCTION_DEFINITION_PARAM','FUNCTION_DEFINITION_RECURSIVE','INCLUDES','PRINTF_STATEMENT']
